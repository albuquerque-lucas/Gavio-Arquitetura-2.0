...
/* harmony import */ var _deleteConfirmation__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./deleteConfirmation */ "./resources/js/deleteConfirmation.js");
/* harmony import */ var _projects_toggleCarousel__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./projects/toggleCarousel */ "./resources/js/projects/toggleCarousel.js");
/* harmony import */ var _projects_toggleCarousel__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(_projects_toggleCarousel__WEBPACK_IMPORTED_MODULE_3__);
/* harmony import */ var _projects_imageUploadProgress__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./projects/imageUploadProgress */ "./resources/js/projects/imageUploadProgress.js");
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  var deleteConfirmationModal = new (bootstrap_js_dist_modal__WEBPACK_IMPORTED_MODULE_0___default())(document.getElementById('deleteConfirmationModal'));
...
/***/ "./resources/js/projects/charCount.js":
/*!********************************************!*\
  !*** ./resources/js/projects/charCount.js ***!
  \********************************************/
/***/ (() => {
...
document.addEventListener('DOMContentLoaded', function () {
  function updateCharacterCountEdit() {
    ...
    var charCountEdit = document.getElementById('charCountEdit');
    charCountEdit.textContent = "".concat(descriptionEdit.value.length, " caracteres");
  }
...
/***/ "./resources/js/projects/imageUploadProgress.js":
/*!******************************************************!*\
  !*** ./resources/js/projects/imageUploadProgress.js ***!
  \******************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
  ...
  form.addEventListener('submit', function (event) {
    ...
    xhr.upload.addEventListener('progress', function (e) {
      if (e.lengthComputable) {
        ...
        uploadPercentage.textContent = "".concat(Math.round(percentComplete), "%");
      }
    });
    xhr.onload = function () {
      if (xhr.status === 200) {
...
/***/ "./resources/js/projects/toggleCarousel.js":
/*!*************************************************!*\
  !*** ./resources/js/projects/toggleCarousel.js ***!
  \*************************************************/
/***/ (() => {
...
document.addEventListener('DOMContentLoaded', function () {
  document.querySelectorAll('.toggle-carousel').forEach(function (button) {
    button.addEventListener('click', function (event) {
      var _this = this;
      event.preventDefault();
      var projectId = this.dataset.projectId;
      var url = "/admin/projetos/".concat(projectId, "/toggleCarousel");
      fetch(url, {
        method: 'PATCH',
        headers: {
...
/******/ 	__webpack_require__.O(undefined, ["css/app","css/publicapp"], () => (__webpack_require__("./resources/js/app.js")))
/******/ 	__webpack_require__.O(undefined, ["css/app","css/publicapp"], () => (__webpack_require__("./resources/scss/app.scss")))
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["css/app","css/publicapp"], () => (__webpack_require__("./resources/scss/publicapp.scss")))
